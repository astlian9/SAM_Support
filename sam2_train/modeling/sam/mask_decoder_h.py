...
class MaskDecoder2_512(nn.Module):
    ...
    def predict_masks(
        ...
        # print(f"msk_feat shape after norm 1{msk_feat.shape}")

        msk_feat = self.self_attn2(q=msk_feat, k=msk_feat, v=msk_feat)
        # print(f"msk_feat shape after attn 2{msk_feat.shape}")
        msk_feat = msk_feat.clone() + self.mlp(msk_feat)
        msk_feat = self.norm2(msk_feat)
        # print(f"msk_feat shape after norm 2{msk_feat.shape}")
        ...
        # print(f"src shape before two-wat-trasnformer{src.shape}")
        # print(f"pos_src{pos_src.shape},tokens{tokens.shape}, mask_feat{mask_feat.shape}")
